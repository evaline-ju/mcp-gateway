...
- Like the previous WASM example, the Python server here just attempts to replace emails and SSNs matching a regex. A small `Process` method is included to satisfy the [external processor spec](https://www.envoyproxy.io/docs/envoy/latest/api-v3/extensions/filters/http/ext_proc/v3/ext_proc.proto).
