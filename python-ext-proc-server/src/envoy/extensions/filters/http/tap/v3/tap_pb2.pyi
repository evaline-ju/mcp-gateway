...
class Tap(_message.Message):
    __slots__ = ("common_config", "record_headers_received_time", "record_downstream_connection")
    ...
    def __init__(self, common_config: _Optional[_Union[_common_pb2.CommonExtensionConfig, _Mapping]] = ..., record_headers_received_time: bool = ..., record_downstream_connection: bool = ...) -> None: ...
