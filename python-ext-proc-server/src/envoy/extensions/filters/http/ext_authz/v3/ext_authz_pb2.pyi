...
class CheckSettings(_message.Message):
    __slots__ = ("context_extensions", "disable_request_body_buffering", "with_request_body")
    ...
    with_request_body: BufferSettings
    def __init__(self, context_extensions: _Optional[_Mapping[str, str]] = ..., disable_request_body_buffering: bool = ..., with_request_body: _Optional[_Union[BufferSettings, _Mapping]] = ...) -> None: ...
