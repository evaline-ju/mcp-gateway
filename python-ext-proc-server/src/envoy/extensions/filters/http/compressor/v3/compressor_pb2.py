...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_COMPRESSOR_RESPONSEDIRECTIONCONFIG'].fields_by_name['uncompressible_response_codes']._loaded_options = None
  _globals['_COMPRESSOR_RESPONSEDIRECTIONCONFIG'].fields_by_name['uncompressible_response_codes']._serialized_options = b'\372B\017\222\001\014\030\001\"\010*\006\020\330\004(\310\001'
  _globals['_COMPRESSOR'].fields_by_name['content_length']._loaded_options = None
  _globals['_COMPRESSOR'].fields_by_name['content_length']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMPRESSOR'].fields_by_name['content_type']._loaded_options = None
  _globals['_COMPRESSOR'].fields_by_name['content_type']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMPRESSOR'].fields_by_name['disable_on_etag_header']._loaded_options = None
  _globals['_COMPRESSOR'].fields_by_name['disable_on_etag_header']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMPRESSOR'].fields_by_name['remove_accept_encoding_header']._loaded_options = None
  _globals['_COMPRESSOR'].fields_by_name['remove_accept_encoding_header']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMPRESSOR'].fields_by_name['runtime_enabled']._loaded_options = None
  _globals['_COMPRESSOR'].fields_by_name['runtime_enabled']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  _globals['_COMPRESSOR'].fields_by_name['compressor_library']._loaded_options = None
  _globals['_COMPRESSOR'].fields_by_name['compressor_library']._serialized_options = b'\372B\005\212\001\002\020\001'
  _globals['_COMPRESSOR']._loaded_options = None
  _globals['_COMPRESSOR']._serialized_options = b'\232\305\210\0363\n1envoy.config.filter.http.compressor.v2.Compressor'
  _globals['_COMPRESSORPERROUTE'].oneofs_by_name['override']._loaded_options = None
  _globals['_COMPRESSORPERROUTE'].oneofs_by_name['override']._serialized_options = b'\370B\001'
  _globals['_COMPRESSORPERROUTE'].fields_by_name['disabled']._loaded_options = None
  _globals['_COMPRESSORPERROUTE'].fields_by_name['disabled']._serialized_options = b'\372B\004j\002\010\001'
  _globals['_COMPRESSOR']._serialized_start=341
  _globals['_COMPRESSOR']._serialized_end=1577
  ...
  _globals['_COMPRESSOR_RESPONSEDIRECTIONCONFIG']._serialized_end=1519
  _globals['_RESPONSEDIRECTIONOVERRIDES']._serialized_start=1579
  _globals['_RESPONSEDIRECTIONOVERRIDES']._serialized_end=1674
  _globals['_COMPRESSOROVERRIDES']._serialized_start=1677
  _globals['_COMPRESSOROVERRIDES']._serialized_end=1806
  _globals['_COMPRESSORPERROUTE']._serialized_start=1809
  _globals['_COMPRESSORPERROUTE']._serialized_end=1962
