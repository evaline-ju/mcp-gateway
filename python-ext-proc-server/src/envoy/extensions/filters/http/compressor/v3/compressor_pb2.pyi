...
class Compressor(_message.Message):
    ...
    class ResponseDirectionConfig(_message.Message):
        __slots__ = ("common_config", "disable_on_etag_header", "remove_accept_encoding_header", "uncompressible_response_codes")
        COMMON_CONFIG_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, common_config: _Optional[_Union[Compressor.CommonDirectionConfig, _Mapping]] = ..., disable_on_etag_header: bool = ..., remove_accept_encoding_header: bool = ..., uncompressible_response_codes: _Optional[_Iterable[int]] = ...) -> None: ...
...
class CompressorOverrides(_message.Message):
    __slots__ = ("response_direction_config",)
    RESPONSE_DIRECTION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    response_direction_config: ResponseDirectionOverrides
    def __init__(self, response_direction_config: _Optional[_Union[ResponseDirectionOverrides, _Mapping]] = ...) -> None: ...
