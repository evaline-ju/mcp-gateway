...
class DynamicModuleFilter(_message.Message):
    __slots__ = ("dynamic_module_config", "filter_name", "filter_config")
    ...
    def __init__(self, dynamic_module_config: _Optional[_Union[_dynamic_modules_pb2.DynamicModuleConfig, _Mapping]] = ..., filter_name: _Optional[str] = ..., filter_config: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...) -> None: ...
