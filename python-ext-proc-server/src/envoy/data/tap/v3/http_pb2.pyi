...
class HttpBufferedTrace(_message.Message):
    __slots__ = ("request", "response", "downstream_connection")
    ...
    def __init__(self, request: _Optional[_Union[HttpBufferedTrace.Message, _Mapping]] = ..., response: _Optional[_Union[HttpBufferedTrace.Message, _Mapping]] = ..., downstream_connection: _Optional[_Union[_common_pb2.Connection, _Mapping]] = ...) -> None: ...
